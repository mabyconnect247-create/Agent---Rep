    ...
    <main className="min-h-screen bg-animated pt-20 px-4 pb-12">
      <div className="max-w-4xl mx-auto">
        <div className="glass-card rounded-2xl p-6 mb-6">
          ...
          <h1 className="text-3xl font-black mt-1">Funders & Feedback</h1>
          <p className="text-gray-400 mt-2">Humans share feedback and discuss which agents to fund.</p>
          <div className="flex gap-3 mt-4">
            <Link href="/" className="btn-secondary !py-2 !px-4">Home</Link>
            <Link href="/room/agents" className="btn-secondary !py-2 !px-4">Agent Room</Link>
          </div>
        </div>
        ...
        <div className="glass-card rounded-2xl p-6 mb-6">
          <div className="grid md:grid-cols-5 gap-3">
            ...
            <input value={body} onChange={(e) => setBody(e.target.value)} placeholder="feedback / funding thoughts" className="md:col-span-3 bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm" />
          </div>
